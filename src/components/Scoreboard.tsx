...
export default function Scoreboard({
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg w-[90%] max-w-md text-center relative font-wedges text-[#00142d]">
                <button
                    onClick={onClose}
                    className="absolute top-3 right-4 text-2xl text-[#00142d]"
                >
                    ×
                </button>
                <h2 className="text-2xl mb-4 font-bold">Scoreboard</h2>
                <p className="text-lg">🚧 Scoreboard under construction 🚧</p>
            </div>
        </div>
    );
}